...
class Think {
    ...
    static public function start() {
      ...
      $runtimefile  = RUNTIME_PATH.APP_MODE.'~runtime.php';//./Application/Runtime/common~runtime.php
      if(!APP_DEBUG && Storage::has($runtimefile)){//未开启调式模式，并且存在common~runtime.php
